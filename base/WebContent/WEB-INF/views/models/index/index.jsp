		...
		<div class="navbar-container" id="navbar-container">
			...
			<div class="navbar-header pull-left">
				...
				<a href="#" class="navbar-brand"> <small> <i
						class="fa fa-leaf"></i> ${productName}
				</small>
				</a>
				...
				<ul class="nav ace-nav">
					...
					<li class="light-blue"><a data-toggle="dropdown" href="#"
						class="dropdown-toggle"> <img class="nav-user-photo"
							src="${ctxStatic}/assets/avatars/user.jpg" alt="Jason's Photo" /> <span
		...
		<div id="sidebar" class="sidebar                  responsive">
			...
			<ul class="nav nav-list">
				...
				<li class="active open"><a href="#" class="dropdown-toggle">
					...
					<ul class="submenu">
						<li class="active open"><a href="#" class="dropdown-toggle">
								<i class="menu-icon fa fa-caret-right"></i> Layouts <b
							...
							<ul class="submenu">
								...
								<li class="active"><a href="two-menu-1.html"> <i
								...
								<div id="sidebar2"
									...
									<ul class="nav nav-list">
										...
										<li class="hover"><a href="#"> <i
												...
												class="menu-text"> Calendar <span title=""
													class="badge badge-transparent tooltip-error"
										...
										<li class="hover"><a href="#"> <i
												class="menu-icon fa fa-picture-o"></i> <span
										...
										<li class="hover"><a class="dropdown-toggle" href="#">
											...
											<ul class="submenu">
												...
												<li class="hover"><a href="#"> <i
														class="menu-icon fa fa-caret-right"></i> Login &amp;
														Register
												</a> <b class="arrow"></b></li>
											</ul></li>

										<li class="hover"><a class="dropdown-toggle" href="#">
												<i class="menu-icon fa fa-file-o"></i> <span
		...
		<div class="footer">
			<div class="footer-inner">
				...
				<div class="footer-content">
					<span class="bigger-120"> <span class="blue bolder">${name }</span>
						${co } &copy; ${year }&nbsp;&nbsp;${email }
					</span>
				</div>
