...
<body class="no-skin">
	...
	<div class="main-container" id="main-container">
		...
		<div id="sidebar" class="sidebar                  responsive">
			...
			<ul class="nav nav-list">
				<c:forEach var="fun" items="${list}" varStatus="num">
					<li class="">
					<a href="javascript:void(0);" class="dropdown-toggle" onclick="loadFunctions('system/show?functionId=${fun.functionId}&userId=${user.userId}')">
					 <i class="menu-icon ${fun.functionIcon }"></i> 
					 <span class="menu-text h4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;${fun.functionName}</span>
					</a>
					</li>
				</c:forEach>
			</ul>
			...
			<ul class="nav nav-list hidden-md hidden-lg" id="phoneFunctionScop">
				<li class="">
					<a href="javascript:void(0);" class="dropdown-toggle" onclick="loadFunctions('system/show?functionId=Function_sys_001_1&userId=User_admin')">
					 <i class="menu-icon fa fa-cogs"></i> 
					 <span class="menu-text h4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;系统管理</span>
					</a>
				</li>
			</ul>
			<!-- /section:basics/sidebar.layout.minimize -->
		...
		<div class="main-content">
			...
			<div class="main-content-inner">
			<div class="page-content" id="main-data">
			</div>
		</div>
		</div>
		<!-- /.main-content -->
