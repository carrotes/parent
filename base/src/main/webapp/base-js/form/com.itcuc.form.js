jQuery(function($) {
	...
	$("#slider-eq > span.ui-slider-purple").slider('disable');// disable third
	// item
	 ...
	 * select element becomes visible with dimensions and chosen works as
	 * expected $('#modal-form').on('shown', function () {
